...
public class SolvedListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreference = new SharedPreference(SolvedListActivity.this);
        ...
        sessionManager = new SessionManager(SolvedListActivity.this);
        ...
        progressDialog = new ProgressDialog(SolvedListActivity.this);
        ...
        adapter = new SubcomplaintListAdapter(SolvedListActivity.this);
        recyclerView.setAdapter(adapter);

        if(SessionManager.isNetworkAvailable(SolvedListActivity.this)){
            syncComplaintsLists();
        }
    ...
    private void syncComplaintsLists() {
        ...
        StringRequest data = new StringRequest(Request.Method.GET,
                getResources().getString(R.string.main_url) + getResources()
                        .getString(R.string.index_complaint) + "GetAllComplain?" + "DistrictId=" + district_id + "&BlockId=" + block_id + "&GPId=" + gp_id + "&villageId=" + village_id + "&role=" + role + "&userid=" + userid +"&status=Resolved",
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() == null) {
                    if (i < 3) {
                        ...
                        Toast.makeText(SolvedListActivity.this, "Check your network connection.",
                                Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
                    }
                } else
                    Toast.makeText(SolvedListActivity.this, error.getMessage(),
                            Toast.LENGTH_LONG).show();
            }
        })
