...
public class ComplaintListActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       sharedPreference = new SharedPreference(ComplaintListActivity.this);
        ...
        header.setText(value + " Village");
        sessionManager = new SessionManager(ComplaintListActivity.this);

        village_id = getIntent().getStringExtra("village_id");

        progressDialog = new ProgressDialog(ComplaintListActivity.this);
        ...
        adapter = new ComplaintListAdapter(ComplaintListActivity.this);
        recyclerView.setAdapter(adapter);
        if(SessionManager.isNetworkAvailable(ComplaintListActivity.this)){
            syncComplaintsLists();
        }
    }
    ...
    private void syncComplaintsLists() {
        ...
        StringRequest data = new StringRequest(Request.Method.GET,
                getResources().getString(R.string.main_url) + getResources()
                        .getString(R.string.index_complaint) + "GetAllComplain?" + "DistrictId=" + "" + "&BlockId=" + "" + "&GPId=" + "" + "&villageId=" + village_id + "&role=" + role + "&userid=" + userid,
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() == null) {
                    if (i < 3) {
                        ...
                        Toast.makeText(ComplaintListActivity.this, "Check your network connection.",
                                Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
                    }
                } else
                    Toast.makeText(ComplaintListActivity.this, error.getMessage(),
                            Toast.LENGTH_LONG).show();
            }
        })
