...
public class PendingListActivity extends AppCompatActivity {
    ...
    String userid,role, status = "Pending",district_id,block_id,gp_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreference = new SharedPreference(PendingListActivity.this);
        ...
        sessionManager = new SessionManager(PendingListActivity.this);
        ...
        progressDialog = new ProgressDialog(PendingListActivity.this);
        ...
        adapter = new SubcomplaintListAdapter(PendingListActivity.this);
        recyclerView.setAdapter(adapter);

        if(SessionManager.isNetworkAvailable(PendingListActivity.this)){
            syncComplaintsLists();
        }
    ...
    private void syncComplaintsLists() {
        ...
        StringRequest data = new StringRequest(Request.Method.GET,
                getResources().getString(R.string.main_url) + getResources()
                        .getString(R.string.index_complaint) + "GetAllComplain?" + "DistrictId=" + district_id + "&BlockId=" + block_id + "&GPId=" + gp_id + "&villageId=" + village_id + "&role=" + role + "&userid=" + userid +"&status=" +status,
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.getMessage() == null) {
                    if (i < 3) {
                        ...
                        Toast.makeText(PendingListActivity.this, "Check your network connection.",
                                Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
                    }
                } else
                    Toast.makeText(PendingListActivity.this, error.getMessage(),
                            Toast.LENGTH_LONG).show();
            }
        })
